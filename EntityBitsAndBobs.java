...
/**
 * Deletes the record of the Bits db table corresponding to the current object instance
 * Precondition: the dbConnectionMaker must have been set
...
/**
 * Constructor creates an EntityBits object, and attempts to load a record from the DB
 * @return IFF the queryPrimaryKey is valid, an EntityBits object populated with the
...
/**
 * Constructor creates an EntityBobs object, and attempts to load a record from the DB
 * @return IFF the queryPrimaryKey is valid, an EntityBobs object populated with the
 *         corresponding values for that record.
